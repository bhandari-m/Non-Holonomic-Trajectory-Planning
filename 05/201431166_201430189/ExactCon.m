...
figure;
plot(time,X);
title('x vs t for Exact Constrained');
xlabel('time');
ylabel('X');

figure;
plot(time,Y);
title('y vs t for Exact Constrained');
xlabel('time');
ylabel('Y');

figure;
plot(time,theta);
title('theta vs t for Exact Constrained');
xlabel('time');
ylabel('theta');

figure;
plot(time,Xdot);
title('Xdot vs t for Exact Constrained');
xlabel('time');
ylabel('Xdot');

figure;
plot(time,Ydot);
title('Ydot vs t for Exact Constrained');
xlabel('time');
ylabel('Ydot');

figure;
plot(X,Y);
title('Y vs X for Exact Constrained');
xlabel('X');
ylabel('Y');